...
def _on_connect(dbapi_connection, **_): 
    pass
    """Set MySQL/POstgreSQL mode to TRADITIONAL on databases that don't set this automatically.

    Without this, DB will silently insert invalid values in the database, causing very long debugging sessions in the
    long run.
    http://www.enricozini.org/2012/tips/sa-sqlmode-traditional/
    """
    #LOG.debug('Setting DB Mode to TRADITIONAL.')
